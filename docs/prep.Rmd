...
Download the newest tar-version from the [source](source/) directory, make sure you know where it has downloaded to and install by opening RStudio and pasting the below code into the R console.
