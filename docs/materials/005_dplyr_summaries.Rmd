...
>
> **1c**: Now add the same two metrics for  bill depth and give the columns clear names. Why could the `drop_na()` step give us wrong results? 
>
...
>
> **3a**: Get the descriptive statistics (mean, sd, min and max) for all the columns ending with "mm", grouped by species. Add a count of how many observations there are of each species in a column named `n`. 
>
